        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center md:text-left md:w-3/5">
            ...
            <p className="mt-4 text-lg md:text-xl opacity-90 max-w-2xl">
              Skip the stress of finding parking spots. PARKACCESS helps you
              find and book parking spaces across Ilorin city with just a few
              clicks.
            </p>
      ...
      <section className="pt-32 pb-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-parking-dark">
              How PARKACCESS Works
            </h2>
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              Our platform makes finding and reserving parking spaces simple,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-parking-dark mb-2">
                  Search & Compare
                </h3>
                <p className="text-gray-600">
                  Enter your location and time to find available parking spots
                  near you. Compare prices and amenities to find your perfect
                  spot.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Reserve your spot instantly with our secure payment system.
                  Support for multiple payment methods including cards and
                  mobile money.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Show your digital parking pass upon arrival. No more circling
                  blocks or struggling to find a spot during peak hours.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic">
                "PARKACCESS has completely changed how I park in the city. I
                used to spend 20+ minutes looking for parking, but now I book
                ahead and just drive straight to my spot."
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic">
                "As a business owner with a small parking lot, PARKACCESS helps
                me generate additional revenue during off-hours. The platform is
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic">
                "As a student, I love that I can find affordable parking near
                campus. The app shows me all available options sorted by price,
                making it easy to stay within my budget."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-parking-primary to-parking-secondary text-white text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-xl opacity-90 max-w-2xl mx-auto">
            Join thousands of drivers who have already simplified their parking
            experience with PARKACCESS.
          </p>
